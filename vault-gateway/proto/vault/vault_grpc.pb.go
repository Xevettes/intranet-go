...
const (
	SecretService_ReadSecret_FullMethodName  = "/secret_proto.SecretService/ReadSecret"
	SecretService_WriteSecret_FullMethodName = "/secret_proto.SecretService/WriteSecret"
	SecretService_ListSecrets_FullMethodName = "/secret_proto.SecretService/ListSecrets"
)
...
func (c *secretServiceClient) ReadSecret(ctx context.Context, in *ReadSecretRequest, opts ...grpc.CallOption) (*ReadSecretResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReadSecretResponse)
	err := c.cc.Invoke(ctx, SecretService_ReadSecret_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *secretServiceClient) WriteSecret(ctx context.Context, in *WriteSecretRequest, opts ...grpc.CallOption) (*WriteSecretResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(WriteSecretResponse)
	err := c.cc.Invoke(ctx, SecretService_WriteSecret_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSecretServiceServer) ReadSecret(context.Context, *ReadSecretRequest) (*ReadSecretResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReadSecret not implemented")
}
func (UnimplementedSecretServiceServer) WriteSecret(context.Context, *WriteSecretRequest) (*WriteSecretResponse, error) {
...
func _SecretService_ReadSecret_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SecretService_ReadSecret_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SecretServiceServer).ReadSecret(ctx, req.(*ReadSecretRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _SecretService_WriteSecret_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(WriteSecretRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SecretServiceServer).WriteSecret(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: SecretService_WriteSecret_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SecretServiceServer).WriteSecret(ctx, req.(*WriteSecretRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var SecretService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "secret_proto.SecretService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _SecretService_WriteSecret_Handler,
		},
		{
